...
android {
    namespace = "com.example.pmu1"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.pmu1"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.ui:ui-graphics") // Версия из BOM
    implementation("androidx.compose.material3:material3") // Версия из BOM
    implementation("androidx.compose.ui:ui-tooling-preview") // Версия из BOM
